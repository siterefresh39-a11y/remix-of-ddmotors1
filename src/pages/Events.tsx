    ...
    <section className="pt-24 md:pt-32 section-padding">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="section-subtitle mb-12 md:mb-20">
          Ogni evento è un'esperienza. Scopri gli eventi che hanno segnato la community e quelli che stanno per arrivare.
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
          ...
          <motion.div
            ...
            onClick={() => setSelectedEventId(event.id)}>
              <img src={event.img} alt={event.title} className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" loading="lazy" width={500} height={667} />
