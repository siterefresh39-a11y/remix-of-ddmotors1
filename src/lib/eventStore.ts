...
export const defaultEvents: EventItem[] = [
  ...
  { id: "ev5", img: locandinaNight, title: "1ST \"DDMOTORS NIGHT\"", desc: "Serata evento: un connubio tra auto e raffinatezza", date: "20th February 2026", status: "Passato", tag: "DDMOTORS NIGHT", location: "Bareggio (MI)", allPhotosLink: "https://example.com/ddmotors-night-photos", coords: [45.3992, 8.9931] },
  { id: "ev4", img: carsBikesCover, title: "1ST \"CARS & BIKES MEETING\"", desc: "Imponente raduno di ogni genere di auto, una serata incredibile", date: "DECEMBER 12TH 2025", status: "Passato", tag: "DDMOTORS RADUNI", location: "Trezzano sul Naviglio (MI)", allPhotosLink: "", coords: [45.4261, 9.0694] },
];
